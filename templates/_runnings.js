exports.header = {
    ...
    contents: function(pageNum, numPages) {
      return '<div style="font-family: <%= font %>;font-size:0.6em;padding:0 0 0.5em 0;margin:0 0.8cm;border-bottom:1px solid #000;position:relative;height:2.2em"><%= topLeft %> <img style="right:0; position:absolute;top:0;height: 1cm" src="<%= assetDir %>common/logo_heg.png" /></div>';
    }
  }
