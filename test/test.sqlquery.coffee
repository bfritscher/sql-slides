...
describe 'SQLQuery', ->
    ...
    describe 'Cache options', ->
        ...
        it '?cache generates a cache file of all data-db blocks', ->
            ...
            html = """
                   <section id="test">
                   <pre data-db="test"><code class="lang-sql">test</code></pre>
                   </section>
                   """
        ...
        it 'can find data in cache file', ->
            ...
            html = """
                   <section id="test">
                   <pre data-db="test" class="run"><code class="lang-sql">test</code></pre>
                   </section>
                   """
            jQuery(html).appendTo 'body'
            SQLQuery.init({location: {pathname: '/test.html', search:''}})
        ...
        it 'error if no connection and no cache', ->
            html = """
                   <section id="test">
                   <pre data-db="test" class="run"><code class="lang-sql"></code></pre>
                   </section>
                   """
            jQuery(html).appendTo 'body'
            SQLQuery.init()
    ...
    describe 'URL options', ->
        beforeEach ->
            html = """
                   <section id="test">
                   <pre><code class="lang-sql">sql1</code></pre>
                   <pre data-db="test" class="run"><code class="lang-sql">sql2</code></pre>
                   <pre data-db="test"><code class="lang-sql">sql3</code></pre>
                   </section>
                   """
            jQuery(html).appendTo 'body'
            server.respondWith [200,
    ...
    describe 'Annotations', ->
        it 'should set attributes contenteditable and spellcheck', ->
            html = """
                   <section id="test">
                   <pre><code class="lang-sql"></code></pre>
                   </section>
                   """
            jQuery(html).appendTo 'body'
            SQLQuery.init()
        ...
        it 'with data-db="SCHEMA" a run button  and output is added', ->
            html = """
                   <section id="test">
                   <pre data-db="test"><code class="lang-sql"></code></pre>
                   </section>
                   """
            jQuery(html).appendTo 'body'
            SQLQuery.init()
        ...
        it 'data-output-fragment-index to add data-fragment-index to output', ->
            html = """
                   <section id="test">
                   <pre data-db="test" data-output-fragment-index="2"><code class="lang-sql"></code></pre>
                   </section>
                   """
            jQuery(html).appendTo 'body'
            SQLQuery.init()
        ...
        it '.start-hidden applies .fragment to output', ->
            html = """
                   <section id="test">
                   <pre data-db="test" class="start-hidden"><code class="lang-sql"></code></pre>
                   </section>
                   """
            jQuery(html).appendTo 'body'
            SQLQuery.init()
        ...
        it '.col2 surrounds with a div.layout-two', ->
            html = """
                   <section id="test">
                   <pre data-db="test" class="col2"><code class="lang-sql"></code></pre>
                   </section>
                   """
            jQuery(html).appendTo 'body'
            SQLQuery.init()
        ...
        it 'a title can be added with data-title', ->
            html = """
                   <section id="test">
                   <pre data-title="atitle" data-db="test"><code class="lang-sql"></code></pre>
                   </section>
                   """
            jQuery(html).appendTo 'body'
            SQLQuery.init()
